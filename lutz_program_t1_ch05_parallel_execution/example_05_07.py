"""
синхронизирует доступ к stdout через блокировку доступа:
так как это общий глобальный объект, данные, которые выводятся из потоков выполнения,
могут перемешиваться, если не синхронизировать операции
"""
