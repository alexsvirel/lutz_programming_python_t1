"""
Меню на основе фреймов:

пригодно для окон верхнего уровня и компонентов
"""
from tkinter import *
...
def makemanu(parent):
    ...
    fbutton = Menubutton(menubar,text='File', underline=0)          # прикрепить Menubutton к Frame
    ...
    edit.add_cascade(label='Staff', menu=submenu, underline=0)
