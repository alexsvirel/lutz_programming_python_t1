...
"""
Использование изображений в панелях инструментов 2 (без PIL)

Пакет PIL можно не использовать при наличии изображений в формате GIF или
в поддерживаемом растровом формате, созданных вручную.
Достаточно просто загружать изображения из файлов, используя стандартный
объект PhotoImage из библиотеки tkinter
...
class NewMenuDemo(Frame):                          # an extended frame
    ...
    def makeToolBar(self, size=(30, 30)):
        imgdir = r'../../PP4E-Examples-1.4/Examples/PP4E/Gui/gifs/'
        toolbar = Frame(self, cursor='hand2', relief=SUNKEN, bd=2)
        toolbar.pack(side=BOTTOM, fill=X)
