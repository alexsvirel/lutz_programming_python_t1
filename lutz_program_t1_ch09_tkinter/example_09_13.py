"""
Демонстрация основных возможностей холста Canvas

В примере используется большинство основных методов
создания изображений на холсте.
"""
...
canvas.create_line(100, 200, 200, 300)  # draw shapes - рисование фигур
...
photo = PhotoImage(file='../../PP4E-Examples-1.4/Examples/PP4E/Gui/gifs/ora-lp4e.gif')
