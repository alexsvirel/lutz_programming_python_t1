...
"""
Использование изображений в панелях инструментов 1 (с помощью PIL)
...
class NewMenuDemo(Frame):                          # an extended frame
    ...
    def makeToolBar(self, size=(40, 40)):
        ...
        imgdir = r'../../PP4E-Examples-1.4/Examples/PP4E/Gui/PIL/images/'
        toolbar = Frame(self, cursor='hand2', relief=SUNKEN, bd=2)
        toolbar.pack(side=BOTTOM, fill=X)
        ...
        for file in photos:
            ...
            imgobj.thumbnail(size, Image.Resampling.LANCZOS)   # best downsize filter
