...
Передавая различные списки выбора в аргументе options и
переопределяя метод runCommand в подклассе, можно повторно
использовать определенный здесь класс компонента ScrolledList
всякий раз когда потребуется вывести список с прокруткой.
"""
from tkinter import *
...
class ScrolledList(Frame):
    ...
    def makeWidgets(self, options):
        ...
        # list.config(selectmode=SINGLE, setgrid=1) # режимы выбора, изменение размеров
