...
В примере реализован простой интерфейс отображения текста с прокруткой,
который может вывести строку текста или файл.
"""
...
class ScrolledText(Frame):
    def __init__(self, parent=None, text='', file=None):
        ...
        self.pack(expand=YES, fill=BOTH)                # сделать растягивающимся
        self.makewidgets()
