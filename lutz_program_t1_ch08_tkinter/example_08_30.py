"""
Создаем два связанных ползунка для запуска демонстрационных диалогов
"""

from tkinter import *                       # импортировать базовый набор виджетов
from examples.dialogTable import demos      # обработчики событий
...
class Demo(Frame):
    def __init__(self, parent=None, **options):
        ...
        Scale(self, label='Pick demo number',
                    command=self.onMove,      # перехватывать переменные
    ...
    def onRun(self):
        ...
        demo = list(demos.values())[pos]    # отображение позиции
        print(demo())
